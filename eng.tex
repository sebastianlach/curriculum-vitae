...
\usepackage{calc}
\usepackage[english,polish]{babel}https://www.overleaf.com/526577kcphsk#
\usepackage{polski}
...
\section{Linkedin}
\doilink{https://pl.linkedin.com/in/sebastianlach}
...
\begin{innerlist}
\item[]
Python, Java, PHP, JavaScript, C++, Bash, AVR.
\end{innerlist}
\vspace{0.1in}

\textbf{Platforms \& Frameworks:}
\begin{innerlist}
\item[]
...
\begin{innerlist}
\item[] Redis, Elasticsearch, Neo4j, MongoDB, Memcached.
\end{innerlist}
\vspace{0.1in}

\textbf{Software Engineering \& Agile:}
\begin{innerlist}
\item[] UML, TDD, BDD, Design Patterns, Continuous Integration.
\end{innerlist}
\vspace{0.1in}

\textbf{Development \& Operations:}
\begin{innerlist}
\item[] Docker, Ansible, Amazon Web Services, Puppet.
\end{innerlist}
\vspace{0.1in}

\textbf{Cloud Computing:}
\begin{innerlist}
\item[] MapReduce, High Availability, Scalablity.
\end{innerlist}
\vspace{0.1in}
